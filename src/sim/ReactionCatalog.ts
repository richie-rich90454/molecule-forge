    ...
    public static buildRules(): IReactionRule[] {
        ...
        return [
            ...
            },
            {
                ...
                reactants: [{ category: null, tag: null, moleculeId: "styrene", count: 6 }],
                ...
                activationEnergy: 25,
                deltaH: -70,
                visual: { flash: "#ace1af", particles: "link" },
            ...
            },
            {
                ...
                reactants: [{ category: null, tag: null, moleculeId: "ethene", count: 10 }],
            ...
            },
            {
                ...
                activationEnergy: 35,
                deltaH: -65,
                visual: { flash: "#ace1af", particles: "puff" },
            ...
            },
            {
                ...
                products: [
                    ...
                    { moleculeId: "carbon-monoxide", count: 12 },
                    { moleculeId: "hydrogen", count: 5 },
                    { moleculeId: "el-c", count: 2 },
                ],
                conditions: {
                    tempMin: 500,
                    tempMax: null,
                ...
                message: "TNT detonates into CO, soot, hydrogen, and nitrogen.",
            },
            {
                id: "detonation-nitroglycerin",
                reactants: [{ category: null, tag: null, moleculeId: "nitroglycerin", count: 4 }],
                products: [
                    { moleculeId: "carbon-dioxide", count: 12 },
                    { moleculeId: "water", count: 10 },
                    { moleculeId: "nitrogen", count: 6 },
            ...
            {
                id: "detonation-rdx",
                reactants: [{ category: null, tag: null, moleculeId: "rdx", count: 1 }],
                products: [
                    { moleculeId: "carbon-monoxide", count: 3 },
                ...
                rateLaw: "detonation front",
                reference: "Energetics handbook",
                message: "RDX detonates into CO, water, and nitrogen.",
            },
            {
                id: "detonation-hmx",
                reactants: [{ category: null, tag: null, moleculeId: "hmx", count: 1 }],
                products: [
                    { moleculeId: "carbon-monoxide", count: 4 },
                    { moleculeId: "water", count: 4 },
                    { moleculeId: "nitrogen", count: 4 },
                ],
                conditions: {
                    tempMin: 480,
                    tempMax: null,
                ...
                rateLaw: "detonation front",
                reference: "Energetics handbook",
                message: "HMX detonates into CO, water, and nitrogen.",
            },
            {
                id: "detonation-picric-acid",
                reactants: [{ category: null, tag: null, moleculeId: "picric-acid", count: 2 }],
                products: [
                    { moleculeId: "carbon-monoxide", count: 12 },
                    { moleculeId: "water", count: 2 },
                    { moleculeId: "hydrogen", count: 1 },
                    { moleculeId: "nitrogen", count: 3 },
                ],
                conditions: {
                    tempMin: 500,
                ...
                rateLaw: "detonation front",
                reference: "Energetics handbook",
                message: "Picric acid detonates into CO, water, hydrogen, and nitrogen.",
            },
            {
                id: "detonation-ammonium-nitrate",
                reactants: [
                    { category: null, tag: null, moleculeId: "ammonium-nitrate", count: 2 },
                ],
                products: [
                    { moleculeId: "nitrogen", count: 2 },
                    { moleculeId: "water", count: 4 },
                    { moleculeId: "oxygen", count: 1 },
                ],
                conditions: {
                ...
                rateLaw: "detonation front",
                reference: "Energetics handbook",
                message: "Ammonium nitrate detonates into nitrogen, water, and oxygen.",
            },
            {
                id: "crystallization",
                reactants: [
            ...
            },
            {
                id: "atp-hydrolysis",
                reactants: [
                    { category: null, tag: null, moleculeId: "atp", count: 1 },
                    { category: null, tag: null, moleculeId: "water", count: 1 },
                ],
                products: [
                ...
                activationEnergy: 18,
                deltaH: -30,
                visual: { flash: "#ace1af", particles: "spark" },
                rateLaw: "k * [ATP]",
                reference: "Biochemistry textbook",
